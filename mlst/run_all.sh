...
F_pe=_R1
R_pe=_R2
#perl ./SsuisSerotyping_pipeline/Ssuis_serotypingPipeline.pl --fastq_directory /home/xiaohu/research/mlst_test/data/gp_b4_raw_reads/M-B4-161_S24_L001_output --scoreName Score_output_type1 --forward $F_pe --reverse $R_pe &> log.txt
